...
public class Teleop extends SampleCommandTeleop {
    @Override
    public void onInit() {
        robot.drive.setDefaultCommand(robot.drive.getDriveFieldcentricSlow(()->g1.getLeftX(),()->g1.getLeftY(), ()->-g1.getRightX(), .75));

        //Stick Direction flipped at the request of James Mcnary
        new Trigger(()->Math.abs(g2.getLeftY())>.05).whileActiveOnce(robot.pivot.getPivotPowerCommand(()->g2.getLeftY()*-1, ()->g2.getButton(GamepadKeys.Button.LEFT_STICK_BUTTON)));
...
//        new Trigger(()->Math.abs(g1.getTrigger(GamepadKeys.Trigger.RIGHT_TRIGGER)-g1.getTrigger(GamepadKeys.Trigger.LEFT_TRIGGER))>.05).whileActiveOnce(robot.climber.getClimberPowerCommand(()->g1.getTrigger(GamepadKeys.Trigger.RIGHT_TRIGGER)-g1.getTrigger(GamepadKeys.Trigger.LEFT_TRIGGER)));
        ...
        new Trigger(() -> g1.getTrigger(GamepadKeys.Trigger.RIGHT_TRIGGER)>.05).whileActiveOnce(robot.drive.getDriveFieldcentricSlow(()->g1.getLeftX(),()->g1.getLeftY(), ()->-g1.getRightX(), .5));
        new Trigger(() -> g1.getTrigger(GamepadKeys.Trigger.LEFT_TRIGGER)>.05).whileActiveOnce(robot.drive.getDriveFieldcentric(()->g1.getLeftX()*1,()->g1.getLeftY()*1, ()->-g1.getRightX()*1));
...
//        g2.getGamepadButton(GamepadKeys.Button.LEFT_BUMPER).whenActive(robot.claw::toggleTwistHorizontalVertical);
        ...
        g2.getGamepadButton(GamepadKeys.Button.Y).whenActive(new ResetToRestCommand(robot.pivot,robot.extendo,robot.wrist));
